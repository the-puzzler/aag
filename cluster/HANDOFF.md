...
- **09-21 06:00:** aag174 wide hybrid (135M) + critic 160 ep: **15.17 @960, still descending steeply** (conv 75M 15.71 @560; 75M hybrid 17.66). Worst plain start (37.8) → best transformer critic result, as width did for the conv. FID-50k pending.
