...
- **09-22 09:00:** aag176 (critic LR 2e-5, 320 ep): window stretched to ~225 ep, fresh 37.4 → **15.78 @1026** with assigned recovering 9.8 → 6.8 alongside (both improving), then a violent runaway (66 → 220 within 30 ep). Fixed multiplier (aag175) and slower critic (aag176) both only move the collapse. Picked ep1026 FID-50k pending.
