...
- **09-12 20:00:** aag137 r32 SEQUENTIAL (MMD 40 ep ckpt 20.93 → big critic 160 ep): dips to **18.91 @454** (14 critic epochs!), bounces to 21.2, settles 19.69 @600 — endpoint ≈ single-stage r32 x critic (20.0/19.3). MMD stage = speed, not a better destination, on r32. FID-50k pending; aag138 (r64 sequential) next.
