...
- **09-10 18:30:** aag112 (MMD on CLS++mean-patch, fixed 0.5, 40 ep): monotonic to **21.17 @440**, still descending, stat 2.3x floor (not saturated) — finer features beat CLS-only (21.84 fixed / 21.47 adaptive min).
