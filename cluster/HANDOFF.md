...
- **09-24 17:00:** aag185 (ImageNet critic continued to 6 ep): 47.0 → 44.6 / 42.9 / **42.6 @22**, flattening, critic winning (df ~0.5). Critic route on ImageNet plateaus ~42.5 FID-10k (MMD on the old assignment: 29.9). FID-50k of ep22 pending. aag186 = MMD CLS++patch fixed 0.5, 4 ep from the AAG3 plain ep16 (the untested combination).
