...
- **09-14 10:30:** aag149 (236M r64 + big critic 160 ep from ep400 at 46.7): **15.55 @560 FID-10k, still descending** (133M: 16.89 @560; 38M: 17.73). FID-50k pending. NOTE: the CelebA target is 138M with equal/fewer params — 133M (15.44) is in budget, 236M is not; wider runs are mechanism evidence, not headline numbers.
