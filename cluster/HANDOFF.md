...
- **09-16 06:30 — over-transport x critic: VERDICT.** aag154 (75M on AAG2 400-block + big critic 160 ep): plateau 19.98 @528–560 vs 15.38 on the floor assignment; AAG1 1M route 19.56. Both over-transported assignments lose ~4.5 FID-10k under the critic (plain: AAG2 −3, AAG1 −7.5). Off-anchor pressure narrows but does not remove the cost → **floor-stop remains the rule.** FID-50k pending. Queue empty.
