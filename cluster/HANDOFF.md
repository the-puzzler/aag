...
- **09-15 07:30:** aag150 (133M critic continuation at weight 0.5): 17.1 → 19.4, critic winning harder (df 0.29, gf 1.8), realised mult ~0.001 — halving the weight makes the late drift WORSE. With aag147 (w1.0, same drift): the drift is an ineffective push (adaptive throttle once the critic wins), not an over-strong one.
